...
void AugmentedView::Render(OpenGL * openGL)
{
	...
	{		
		...
		glUniformMatrix4fv(renderData.modelMatrixLocation, 1, GL_TRUE, modelMatrix.ptr<float>());
...
{	
	...
	glUniformMatrix4fv(renderData.projectionMatrixLocation, 1, GL_TRUE, projection.ptr<float>());	
